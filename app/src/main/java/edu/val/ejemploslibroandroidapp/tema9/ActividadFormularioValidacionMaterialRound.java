...
public class ActividadFormularioValidacionMaterialRound extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad_formulario_validacion_material_r);
    ...
    public void botonAceptarPulsado(View view) {
        ...
        //DIBUJAR EL SNACKBAR BARRA EMERGENTE
        Snackbar snackbar = Snackbar.make(view, "FORM VALIDADO", BaseTransientBottomBar.LENGTH_LONG);
        snackbar.show();
        snackbar.setAction(this.forumlario_valido+"", this::botonAceptarPulsado);
        int color_accion = (this.forumlario_valido) ? (getResources().getColor(R.color.miverde)) : (getResources().getColor(R.color.miamarillo));
        snackbar.setActionTextColor(color_accion);
