...
public class ActividadFormularioIntentSerial extends AppCompatActivity {
    ...
    public void botonAceptarPulsado(View view) {
       ...
       InfoFormulario infoFormulario = new InfoFormulario(this.editTextNombre.getText().toString(), Integer.parseInt(this.editTextEdad.getText().toString()),this.radioButtonHombre.isChecked(), this.radioButtonMujer.isChecked(), this.checkBoxMayorEdad.isChecked() );
        Log.d(MainActivity.ETIQUETA_LOG, "INfo enviada "+ infoFormulario);

       Intent intent = new Intent(this, ActividadBienvenidaSerial.class);
       intent.putExtra("FORMULARIO", infoFormulario);
